...
# ═══════════════════════════════════════════════════════════
n_candles = 85
tf_input = "1wk"          # تغییر یافته: هفتگی
search_interval = "1wk"   # تغییر یافته: جستجو در هفتگی
...
crypto_symbols = [
    ...
    "ANIME-USD", "EPIC-USD", "NOT-USD", "LTC-USD", "CAKE-USD",
    "WIF-USD", "SUI-USD", "ACA-USD", "PUMP-USD", "HOME-USD",
    "LAB-USD", "AAVE-USD", "CAP-USD", "XAN-USD", "ACT-USD",
    "BANK-USD", "GRAM-USD", "HEI-USD", "ZEC-USD", "SIREN-USD",
    "ARIA-USD", "DEXE-USD", "GENIUS-USD", "FET-USD", "UB-USD",
    "BICO-USD", "HMSTR-USD", "BIGTIME-USD", "TAC-USD", "UAI-USD",
    "UNI-USD", "YB-USD", "NEIRO-USD", "ELIZAOS-USD", "XLM-USD",
    "ALLO-USD", "ESP-USD", "TA-USD", "ROBO-USD", "LA-USD",
    "MAV-USD", "KGEN-USD", "LUNC-USD", "FOGO-USD", "ROAM-USD",
    "PARTI-USD", "BILL-USD", "SPK-USD", "HNT-USD", "FIL-USD"
]
